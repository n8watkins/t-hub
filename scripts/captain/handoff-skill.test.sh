...
grep -Fq 'durable agent session' "$SKILL"
grep -Fq 'Never retrieve or pass legacy service credentials' "$SKILL"
grep -Fq 'no sanctioned checkpoint surface is available' "$SKILL"
