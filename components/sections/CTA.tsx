        ...
        >
          ...
          <div className="relative">
            ...
            <h2 className="mx-auto max-w-2xl text-3xl font-extrabold tracking-tight text-slate-50 sm:text-5xl">
              Stop seeding through windows.
              <br />
              <span className="gradient-text">Supervise the whole fleet.</span>
            </h2>
            <p className="mx-auto mt-5 max-w-xl text-haze">
              Download T-Hub free from GitHub and run your Claude Code sessions
              the way they deserve — locally, on your machine, no subscription. If
              it&apos;s useful, a star keeps it moving.
            </p>
            ...
            <div className="mt-9 flex flex-wrap items-center justify-center gap-3">
              ...
              <a
                ...
                target="_blank"
                rel="noopener noreferrer"
                className="group flex items-center gap-2 rounded-xl border border-white/12 bg-white/[0.05] px-7 py-3.5 text-sm font-bold text-slate-100 transition-all hover:scale-[1.04] hover:bg-white/[0.1]"
              >
                <Star className="h-5 w-5 text-amber-300 transition-transform group-hover:rotate-12" />
                Star on GitHub
                <Github className="h-4 w-4 text-slate-400" />
              </a>
            </div>
            <p className="mt-5 text-xs text-slate-600">
              Windows + WSL-first · open source · a tool by n8builds
            </p>
          </div>
        </motion.div>
      </div>
