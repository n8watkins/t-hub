...
Run `pnpm test` for the fast local profile and `pnpm test:full` for the complete process and browser profile.
See [docs/TESTING.md](./docs/TESTING.md) for profile boundaries, measured costs, and release guidance.
